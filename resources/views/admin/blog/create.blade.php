                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control flatpicker @error('date') is-invalid @enderror"
                                    name="date" id="" value="{{ old('date') }}" placeholder=""
                                    autocomplete="off">
                                @error('date')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                        ...
                        <div class="col-md-4">
                            <div class="card card-body seo my-3 shadow br-8 p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="seo_schema" id="" cols="30" rows="10"
                                        class="form-control @error('seo_schema') is-invalid @enderror">{{ old('seo_schema') }}</textarea>
                                    @error('seo_schema')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
